...
class PermissionController extends Controller
{
    ...
    {   
        ...
        return $this->runInTenant($request->tenant_id, function () use ($request) {
            if($request->select == true){
                ...
                $permissions = Cache::tags(['permissions_list'])->rememberForever($cacheKey, function () use ($request) {
                    ...
                    return  $permissions->orderBy($sort, $dir)->paginate($limit);
                });
            }
    ...
    public function show(Request $request, int $id): JsonResponse
    {
        ...
        return $this->runInTenant($request->tenant_id, function () use ($id) {
            $permission = Permission::select('id', 'name')->where('id', $id)->first();
            if (!$permission) {
